...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Config::get('URL'); ?>landing/assets/stylesheet/faq.css">
...
<header>
    <div class="container">
        <h1><span><img src="<?php echo Config::get('URL'); ?>landing/assets/images/icons/question.png" alt="question"></span> Preguntas Frecuentes</h1>
    </div>
</header>
...
<div class="container">
    <hr>
    <p><a>¿Qué es CEOsim?</a></p>
    <p><a>¿Como funciona CEOsim?</a></p>
    <p><a>¿Como adquiero CEOsim?</a></p>
    <br>
</div>
<footer>
