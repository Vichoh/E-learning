            ...
            <div class="wrapper" id="rows">
                <div class="" id="container">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-sm-6 col-md-8 col-lg-4  col-xl-4 bg-white pt-3 bd-primary  box-shadow " id="col-login">
                            <h5 class="bg-info pt-2 pb-2 pl-2 pr-2 text-center text-white">INICIAR SESIÓN</h5>
                            <?php $this->renderFeedbackMessages(); ?>
                            <form action="<?php echo Config::get('URL'); ?>login/login" class="mr-2 ml-2" method="post">
                                <div class="form-group">
                                    <label class="pt-2" for="email">E-mail o Nombre de Usuario</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></div>
                                        <input autofocus class="form-control" type="text" name="user_name" placeholder="Username or email" required/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input required type="password" class="form-control" name="user_password" placeholder="Contraseña" required />
                                    </div>
                                    <div class="form-group text-center">
                                        <label for="set_remember_me_cookie" class="remember-me-label pt-3">
                                            <a href="<?php echo Config::get('URL'); ?>login/requestPasswordReset" class="btn btn-xs btn-link next" tabindex="4">¿olvidé mi contraseña?</a>
                                        </label>
                                    </div>
                                </div>
                                <div class="checkbox mb-2">
                                    <label for="set_remember_me_cookie" class="remember-me-label">
                                        <input type="checkbox" name="set_remember_me_cookie" class="remember-me-checkbox" /> Recordarme por 2 semanas
                                    </label>
                                </div>
                                <input type="hidden" name="csrf_token" value="<?= Csrf::makeToken(); ?>" />
                                <input type="submit" class="btn btn-block btn-info login-submit-button pt-2" tabindex="3" value="Login"/>
                            </form>
                            <hr>
                            <div class="row">
                                <div class="col-12 text-center">
                                    <label for="set_remember_me_cookie" class="remember-me-label">
                                        <a href="<?php echo Config::get('URL'); ?>register/index" tabindex="5" class="next">Registrar</a>
                                    </label>
                                </div>
                            </div>
