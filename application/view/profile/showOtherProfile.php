    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-10 login mt-3 bd-primary pr-0 pl-0" style="background-color: white ">
                    ...
                    <div class="col-4 pb-2">
                        <div class="card text-center">
                            ...
                            <div class="card-block">
                                <h4 class="card-title text-primary"><?= $this->user->user_name; ?>
                ...
                <a href="<?php echo Config::get('URL'); ?>group/view/<?php echo htmlentities($this->id_group); ?>/<?php echo htmlentities($this->admin); ?>" class="btn btn-success"> <i class="fa fa-chevron-left" aria-hidden="true"></i> Volver </a>
            </div>
            </div>
            <div class="col-2">
