...
return array(
    ...
    /**
     * Configuration for: Market paths
     * Internal path to save market images. Make sure this folder is writable.
     */
    'PATH_MARKET' => realpath(dirname(__FILE__).'/../../') . '/public/img/market/',
    /**
    ...
    'EMAIL_SMTP_USERNAME' => 'ceosim.chile@gmail.com',
    'EMAIL_SMTP_PASSWORD' => 'Ceosim2017Chile',
    'EMAIL_SMTP_PORT' => 465,
    ...
    'EMAIL_PASSWORD_RESET_FROM_EMAIL' => 'ceosim.chile@gmail.com',
    'EMAIL_PASSWORD_RESET_FROM_NAME' => 'CEOSIM',
    'EMAIL_PASSWORD_RESET_SUBJECT' => 'Restablecer contraseña',
    'EMAIL_PASSWORD_RESET_CONTENT' => 'Por favor, haga click en el siguiente link para restablecer su contraseña: ',
    'EMAIL_VERIFICATION_URL' => 'register/verify',
    'EMAIL_VERIFICATION_FROM_EMAIL' => 'ceosim.chile@gmail.com',
    'EMAIL_VERIFICATION_FROM_NAME' => 'CEOSIM',
    'EMAIL_VERIFICATION_SUBJECT' => 'Activación de su cuenta',
    'EMAIL_VERIFICATION_CONTENT' => 'Por favor, haga click en el siguiente link para activar su cuenta: ',
);
